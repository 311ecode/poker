...
|---|---|---|---|---|
| **[001a](POKER-001a-server-protocol-core.md)** | server core: HTTP + WS protocol, rooms, votes, name claims | poker | — (spine) | — |
| **[001b](POKER-001b-room-file-db.md)** | the database: one JSON file per room, atomic + serialized writes | poker | contract §1.1 | a, c, d, e |
