...
- [ ] AC1 — Typing a question and opening the vote creates a vote with that title **and leaves the
  question box empty**.
- [ ] AC2 — Another member opening a vote does **not** clear this browser's half-typed question.
- [ ] AC3 — The box is capped at 80 characters.
